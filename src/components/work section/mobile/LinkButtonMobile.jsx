...
const commonStyle =
  "px-3 py-0.5 bg-green-400 rounded-xl relative flex items-center border-2 border-green-950 font-semibold capitalize justify-center"
